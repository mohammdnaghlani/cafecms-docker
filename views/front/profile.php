                                        ...
                                        <div class="col-12">
                                            <div class="profile-recent-fav-row">
                                                <a href="#" class="profile-recent-fav-col profile-recent-fav-col-thumb">
                                                    <img src="<?=getFrontAssets('img/cart/4560621.jpg')?>"></a>
                                            ...
                                            <div class="profile-recent-fav-row">
                                                <a href="#" class="profile-recent-fav-col profile-recent-fav-col-thumb">
                                                    <img src="<?=getFrontAssets('img/cart/3794614.jpg')?>"></a>
                                                <div class="profile-recent-fav-col profile-recent-fav-col-title">
                                                    <a href="#">
                                                        <h4 class="profile-recent-fav-name">
                                                            گوشی موبایل اپل مدل iPhone XR دو سیم کارت ظرفیت 256 گیگابایت
                        ...
                        <div class="profile-box">
                            <div class="profile-box-header">
                                <div class="profile-box-avatar">
                                    <img src="<?=getFrontAssets('img/svg/user.svg')?>" alt="">
                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <ul class="profile-avatars default text-center">
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/user.svg')?>"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/avatar-1.svg')?>"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/avatar-2.svg')?>"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/avatar-3.svg')?>"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/avatar-4.svg')?>"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/avatar-5.svg')?>"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/avatar-6.svg')?>"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="<?=getFrontAssets('img/svg/avatar-7.svg')?>"></img>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="profile-box-tabs">
                                ...
                                <a href="<?=getUriByAliensName('logout')?>" class="profile-box-tab profile-box-tab--sign-out">
