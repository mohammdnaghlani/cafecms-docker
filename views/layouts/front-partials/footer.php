                ...
                <div class="info">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4 text-center">
                            <a href="#" target="_blank"><img src="<?=getFrontAssets('img/bazzar.png') ; ?>" width="159" height="48"
                                    alt=""></a>
                            <a href="#" target="_blank"><img src="<?=getFrontAssets('img/sibapp.png') ; ?>" width="159" height="48"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="symbol col-12 col-lg-5">
                            <a href="#" target="_blank"><img src="<?=getFrontAssets('img/symbol-01.png') ; ?>" alt=""></a>
                            <a href="#" target="_blank"><img src="<?=getFrontAssets('img/symbol-02.png') ; ?>" alt=""></a>
                        </div>
                        <div class="col-12">
                            <div class="row">
                                <ul class="footer-partners default">
                                    <li class="col-md-3 col-sm-6">
                                        <a href=""><img src="<?=getFrontAssets('img/footer/1.svg') ; ?>" alt=""></a>
                                    </li>
                                    <li class="col-md-3 col-sm-6">
                                        <a href=""><img src="<?=getFrontAssets('img/footer/2.svg') ; ?>" alt=""></a>
                                    </li>
                                    <li class="col-md-3 col-sm-6">
                                        <a href=""><img src="<?=getFrontAssets('img/footer/3.svg') ; ?>" alt=""></a>
                                    </li>
                                    <li class="col-md-3 col-sm-6">
                                        <a href=""><img src="<?=getFrontAssets('img/footer/4.svg') ; ?>" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
